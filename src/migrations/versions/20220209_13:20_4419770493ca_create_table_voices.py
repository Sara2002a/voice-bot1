...
def upgrade():
    op.create_table(
        ...
        sa.Column("link", sa.VARCHAR(length=2000), nullable=False, comment="Link"),
        sa.Column("telegram_file_id", sa.VARCHAR(length=1000), nullable=False, comment="Telegram File ID"),
